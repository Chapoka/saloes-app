      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-500">As ações do sistema aparecerão aqui</p>
          </div>
        ) : (
            ...
            {filteredLogs.map((log) => {
              ...
              return (
                <div 
                  key={log.id}
                  className={cn(
                    "bg-white rounded-2xl shadow-sm border-l-4 p-5 hover:shadow-md transition-all",
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        <Badge className={cn("text-xs", categoryColors[log.category] || "bg-gray-100 text-gray-700")}>
