...
const allNavItems = [
  ...
  { name: "Planos",          icon: Package,         page: "Plans",       roles: ["super_admin","admin","profissional"] },
  { name: "Punch Cards",      icon: CreditCard,      page: "PunchCards",  roles: ["super_admin","admin","profissional"] },
  ...
  { name: "Cobranças",       icon: CreditCard,      page: "Invoices",    roles: ["super_admin","admin","profissional"] },
  { name: "Fila de Espera",  icon: ListOrdered,     page: "WaitingList", roles: ["super_admin","admin","profissional"] },
  { name: "Templates",       icon: MessageSquare,   page: "Templates",   roles: ["super_admin","admin","profissional"] },
