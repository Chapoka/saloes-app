...
const PAGE_ROLES = {
  ...
  Plans: ['super_admin', 'admin', 'profissional'],
  PunchCards: ['super_admin', 'admin', 'profissional'],
  Services: ['super_admin', 'admin', 'profissional'],
  StylistLevels: ['super_admin', 'admin'],
  Invoices: ['super_admin', 'admin', 'profissional'],
  WaitingList: ['super_admin', 'admin', 'profissional'],
  Templates: ['super_admin', 'admin', 'profissional'],
